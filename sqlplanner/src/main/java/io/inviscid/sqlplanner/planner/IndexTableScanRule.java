 ...
 * of a {@link io.inviscid.sqlplanner.planner.MartTable}
 * to a {@link io.inviscid.sqlplanner.planner.LogicalIndexTableScan}.
 *
...
public class IndexTableScanRule extends RelOptRule {
  ...
  public static final io.inviscid.sqlplanner.planner.IndexTableScanRule INSTANCE =
      new io.inviscid.sqlplanner.planner.IndexTableScanRule(
