...
class ConnectionsTest {
  ...
  static void setUp() throws SQLException {
    ...
    try (Statement insert = h2db.createStatement()) {
      insert.execute("insert into stv_sessions values('2018-01-01 00:00:00', 10, 'user_1', 'db_1')");
      insert.execute("insert into stv_sessions values('2018-01-02 00:00:00', 11, 'user_1', 'db_2')");
      insert.execute("insert into stv_sessions values('2018-01-01 00:00:00', 12, 'user_1', 'db_1')");
      insert.execute("insert into stv_sessions values('2018-01-01 00:00:00', 13, 'user_12', 'db_10')");
      insert.execute("insert into stv_sessions values('2018-01-01 00:00:00', 14, 'user_13', 'db_1')");
    }
  }
